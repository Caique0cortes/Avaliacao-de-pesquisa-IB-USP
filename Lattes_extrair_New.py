...
#Inserir a pasta do diretório em "path" (a pasta deve ser o nome do departamento) 
path = 'C:\\Users\\corte\\OneDrive\\Documentos\\Programação\\IB\\Teste_novo_extrair_lattes\Botanica'
